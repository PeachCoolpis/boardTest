package io.board.security.manager;

import io.board.repository.ResourcesRepository;
import io.board.security.role.PersistentUrlRoleMapper;
import io.board.service.impl.DynamicAuthorizationServiceImpl;
...
@Component(value = "spaAuthorizationManager")
@RequiredArgsConstructor
public class SpaAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {
